...
class ReciterContent extends StatefulWidget {
  const ReciterContent({super.key});

  @override
  State<ReciterContent> createState() => _ReciterContentState();
}

class _ReciterContentState extends State<ReciterContent> {
